...
const discussionGroupSchema = new Schema({
    groupName: String,
    member: enum: [{ type: Schema.Types.ObjectId, ref: "Mentor"}, { type: Schema.Types.ObjectId, ref: "Trainer"}, { type: Schema.Types.ObjectId, ref: "Student"}, { type: Schema.Types.ObjectId, ref: "User"}]     
});
